...
:: out3 = ac3 2.0
::
set complex_filter="[0:a:0]asplit=2[out1][out2];[out1]volume=-6dB[a1];[out2]pan=stereo|c0=1.0*FL+0.707*SL+%highervoiceval%*FC+%LFEstring%|c1=1.0*FR+0.707*SL+%highervoiceval%*FC+%LFEstring%,volume=-6dB[a2]"
